...
parser = argparse.ArgumentParser(
        description='Strip duplicate sections from Launch.log files',
        epilog="""
            NOTE: The section seen *first* is the one that will be kept.
            Any subsequent sections with the same name will be omitted.
            Also, this util assumes CRLF line endings on the Launch.log file,
...
parser.add_argument('-f', '--filename',
        type=str,
        required=True,
        help='The filename from which to strip the section',
        )
...
print(f'Done, filtered {filtered} lines')
